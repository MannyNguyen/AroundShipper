...
public class DetailLocationFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        receiveShop = (CheckBox) view.findViewById(R.id.receive_shop);
        receiveShop.setClickable(false);
        receiveShop.setAlpha(1);
    }
                        ...
                        public void run() {
                            ...
                            switch (getArguments().getString("type")) {
                                case PICKUP:
                                    ...
                                    receiveShop.setVisibility(View.GONE);
                                    break;
                                case GIFTING:
                                    ...
                                    receiveShop.setVisibility(View.VISIBLE);
                                    if (getArguments().getInt("status") == FullOrderCommonFragment.FOLLOW) {
                                        receiveShop.setClickable(true);
                                    }
                                    //Todo
                                    break;
                            }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            receiveShop.setOnCheckedChangeListener(null);
                            if (bean.getReceive_shop_product_status() == SELECTED) {
                                receiveShop.setChecked(true);
                            } else {
                                receiveShop.setChecked(false);
                            }
                            ...
                            switch (getArguments().getString("type")) {
                                case PICKUP:
                                    ...
                                    if (itemcost == 0) {
                                        ...
                                        itemCost.setText(CmmFunc.formatMoney(itemcost));
                                    }
...
//                                    recycler.setAdapter(adapter);
                                ...
                                case GIFTING:
                                    ...
                                    receiveShop.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                                        @Override
                                        public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                                            ((BaseFragment) getParentFragment()).showProgress();
                                            int status = UNSELECTED;
                                            if (b) {
                                                status = SELECTED;
                                            }
                                            SmartFoxHelper.receiveShopShipper(bean.getId(), status);
                                    ...
                                    for (BeanItem item : bean.getLocation_items()) {
                                        ...
                                        fee.setText(CmmFunc.formatMoney(item.getItem_cost()));
                            ...
                            if (bean.getBill_price() > 0) {
                                ...
                                actualMoney.setText(CmmFunc.formatMoney(bean.getBill_price()));
                            }
