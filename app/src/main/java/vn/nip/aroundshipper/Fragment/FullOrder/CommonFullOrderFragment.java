...
public class CommonFullOrderFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static CommonFullOrderFragment newInstance(String type, String locations, int status) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_common_full_order2, container, false);
        return view;
    }
                        ...
                        public void run() {
                            ...
                            switch (getArguments().getString("type")) {
                                ...
                                case GIFTING:
                                    ...
                                    if (getArguments().getInt("status") == FOLLOW) {
