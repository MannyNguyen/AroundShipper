...
public class BeanPoint {
    ...
    private int receive_shop_product_status;
    ...
    public int getReceive_shop_product_status() {
        return receive_shop_product_status;
    }

    public void setReceive_shop_product_status(int receive_shop_product_status) {
        this.receive_shop_product_status = receive_shop_product_status;
    }
